...
import { LoaderIcon, PlayIcon, UserIcon } from "lucide-react";
...
export function PlayAsCharacterButton({
  adventureId,
  onboardingParams,
  fastOnboard,
  isDevelopment = false,
  ...
  if (loading) {
    return (
      <Button
        className="text-white bg-indigo-500 hover:bg-indigo-700 p-4 text-lg flex gap-2"
        disabled={true}
      >
        <LoaderIcon className="z-10" />
        Start adventure
      </Button>
    );
  }
